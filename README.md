...
<html>
    <head>
        ...
        <!-- Just so you know, ENTERNAL LINKS ARE DOWN, I think. Please be patient. Thanks!-->
    ...
    <style>
      ...
      .neyoyo {
        ...
        <h2 class="k" id="wattaton">The place with all the mangos you will ever need!</h2>
         ...
         <a href="#iddi"><li class="tracemcsorley">⬇ See the full list</li></a>
         
         <a href="#password"><li class="tracemcsorley">⬇ See the full list</li></a>
         
         <a href="#ranbooourbeloved"><li class="tracemcsorley">⬇ See the full list</li></a>
         
         <a href="#-tubboyouspin"><li class="tracemcsorley">⬇ See the full list</li></a>
         
         <a href="#dremspeed"><li class="tracemcsorley">⬇ See the full list</li></a>
         
         <a href="#immagnome"><li class="tracemcsorley">⬇ See the full list</li></a>
         
         <a href="#more-programmers"><li class="tracemcsorley">⬇ See the full list</li></a>



        <h3 id="undathetreebumbumbumbum" class="hahaha" id="iddi"><strong>Why You Should Go To Sri Lanka</strong></h3>
        
        <p class="tracemcsorley"><strong>I think you should go to  Sri Lanka!</strong> Why, you ask? Because <strong>IT IS <em>AWESOME</em> THERE!</strong> The wildlife there is thriving, There is so much greenery, the people the are SO nice and welcoming, and there is so much things to do! They have many natural landmarks as well as a thriving religon. There are beaches, amazing hikes, temples, and gardens. There are astounding trails, riverside walks, places for sightseeing, and wonderful resturants.<strong> It is truly a wonderful place to be.</strong></p>
        ...
        <h3 id="joemama" class="hahaha" id="y" id="password">Reasons To Go To Sri Lanka!</h3>
        
        <li class="tracemcsorley"><strong>It is always sunny!</strong> </li>
      ...
      <li class="tracemcsorley">Many temples!</li>
        ...
        <br><br><br><br><a href="#top"><li class="tracemcsorley" >⬇ See the full list</li></a>
